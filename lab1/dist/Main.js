...
var _ferborva$elm_lab$Main$fetchRandomQuoteCompleted = F2(
					...
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_ferborva$elm_lab$Main$GetQuote),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _ferborva$elm_lab$Main$main = _elm_lang$html$Html$program(
	{
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ferborva$elm_lab$Main$main !== 'undefined') {
    _ferborva$elm_lab$Main$main(Elm['Main'], 'Main', undefined);
}
